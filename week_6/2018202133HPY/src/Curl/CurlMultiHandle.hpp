#ifndef _COWR_CURL_CURLMULTIHANDLE

#define _COWR_CURL_CURLMULTIHANDLE
...
public:
    ...
    public:
            ...
            , TLE(false)
        {
            ...
            timeout_ms = std::stoi(Config::getInstance()["EasyHandle"]["timeout"]);
        }
...
public:
    ...
    {
        max_num = std::stoi(Config::getInstance()["MultiHandle"]["handles"]);
    }
